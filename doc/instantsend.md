...
This mechanism has been integrated into Bitcore-Node-Cup which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cuppay/insight-api-cup#web-socket-api](https://github.com/cuppay/insight-api-cup#web-socket-api)
* API: [https://github.com/cuppay/insight-api-cup#instantsend-transactions](https://github.com/cuppay/insight-api-cup#instantsend-transactions)
...
By default, the Cup Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cup Core daemon:
