...
Only requiring some minor changes is cup.cpp.
...
Changes to cup.cpp
----------------------
cup.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
