...
Cup now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start cup-address monthly-payment-cup```
...
Format: ```mngovernance submit proposal-name url payment-count block-start cup-address monthly-payment-cup fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using cup.conf setup)
