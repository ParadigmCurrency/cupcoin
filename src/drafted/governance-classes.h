 ...
 *
 *   // network
 *   CCupNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cup.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCupNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CupNetwork
// //   -- signature requirements : Key1(User)
// class CCupNetworkVariable : public CGovernanceObject
// {
// private:
