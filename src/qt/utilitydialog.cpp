    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Cup Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Cup Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cup-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Cup in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://cuppay.atlassian.net/wiki/display/DOC/PrivateSend\">https://cuppay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Cup Core is shutting down...") + "<br /><br />" +
