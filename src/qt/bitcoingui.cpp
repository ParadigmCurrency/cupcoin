    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Cup Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cup address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cup: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Cup Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cup Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cup Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cup addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cup addresses"));
    ...
    openAction->setStatusTip(tr("Open a cup: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cup Core help message to get a list with possible Cup Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Cup Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cup network", "", count));
    } else {
...
{
    QString strTitle = tr("Cup Core"); // default title
